    ...
    <div className="space-y-6 fade-in">
      ...
      <div className="flex items-center justify-between border-b border-border/40 pb-3">
        ...
        <span className="flex items-center gap-2 text-[10px] font-semibold text-muted-foreground uppercase tracking-widest">
          Demo Report
          <span className="inline-flex items-center px-2 py-0.5 rounded-full bg-accent/10 text-accent text-[9px] font-bold">
            Preview
          </span>
        </span>
      </div>
        ...
        <aside className="space-y-4">
          ...
          <div className="rounded-2xl border border-border/60 bg-card p-5 space-y-4 shadow-sm">
            ...
            <p className="text-[11px] text-muted-foreground leading-relaxed">
              This is a pre-loaded demo showing how WazobiCare translates lab results across all four supported languages.
            </p>
            <ul className="space-y-2 text-[11px] text-foreground/80">
              ...
              <li className="flex gap-2"><span className="text-accent">•</span><span>Browse tabs: Summary, Findings, Interpretation</span></li>
              <li className="flex gap-2"><span className="text-accent">•</span><span>Listen to Yoruba & Hausa audio (real generated audio)</span></li>
              <li className="flex gap-2"><span className="text-accent">•</span><span>Download PDF report</span></li>
            </ul>
          ...
          <Link
            href="/upload"
            className="block text-center rounded-2xl border border-accent/30 bg-accent/5 p-4 text-xs font-semibold text-accent hover:bg-accent/10 transition-colors"
          >
