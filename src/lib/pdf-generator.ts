...
export async function generateReportPdf(input: PdfReportInput): Promise<Uint8Array> {
  ...
  // ─── Cover ───
  page.drawText("WazobiaCare Nigeria", {
    x: MARGIN, y,
    size: 20,
    font: boldFont,
  ...
  const disclaimer =
    "WazobiaCare provides educational translations and AI-powered analysis of lab reports. " +
    "This document is not a clinical diagnosis. Always consult a qualified healthcare professional " +
    "for medical decisions. Generated by WazobiaCare Nigeria.";
  const maxW = width - MARGIN * 2;
